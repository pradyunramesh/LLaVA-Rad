...
def evaluate_race_table(test_chexpert_reports, model_type, metric):
    '''
    ...
    race_df = pd.DataFrame(columns = ['Race 1', 'Race 2', f'{metric}: Race 1', f'{metric}: Race 2', 'P-Value', 'Statistical Significance'])
    for x, y in combinations(race_columns, 2):
        ...
        score_1_og = calculate_metric(labeled_col, original_col, metric)
        ...
        score_2_og = calculate_metric(labeled_col, original_col, metric)
        ...
        new_data = pd.DataFrame([{'Race 1': x, 'Race 2': y, f'{metric}: Race 1': score_1_og, f'{metric}: Race 2': score_2_og, 'P-Value': p_value, 'Statistical Significance': significance}])
...
def evaluate_sex_table(test_chexpert_reports, model_type, metric):
    '''
    ...
    sex_df = pd.DataFrame(columns = ['Sex 1', 'Sex 2', f'{metric}: Sex 1', f'{metric}: Sex 2', 'P-Value', 'Statistical Significance'])
    for x, y in combinations(sex_columns, 2):
        ...
        new_data = pd.DataFrame([{'Sex 1': x, 'Sex 2': y, f'{metric}: Sex 1': score_1_og, f'{metric}: Sex 2': score_2_og, 'P-Value': p_value, 'Statistical Significance': significance}])
...
def evaluate_age_table(test_chexpert_reports, model_type, metric):
    '''
    ...
    age_df = pd.DataFrame(columns = ['Age 1', 'Age 2', f'{metric}: Age 1', f'{metric}: Age 2', 'P-Value', 'Statistical Significance'])
    for x, y in combinations(age_columns, 2):
        ...
        new_data = pd.DataFrame([{'Age 1': x, 'Age 2': y, f'{metric}: Age 1': score_1_og, f'{metric}: Age 2': score_2_og, 'P-Value': p_value, 'Statistical Significance': significance}])
...
def evaluate_race_sex_table(test_chexpert_reports, model_type, metric):
    '''
    ...
    race_sex_df = pd.DataFrame(columns = ['Group 1', 'Group 2', f'{metric}: Group 1', f'{metric}: Group 2', 'P-Value', 'Statistical Significance'])
    for x, y in combinations(race_sex_columns, 2):
        ...
        new_data = pd.DataFrame([{'Group 1': x, 'Group 2': y, f'{metric}: Group 1': score_1_og, f'{metric}: Group 2': score_2_og, 'P-Value': p_value, 'Statistical Significance': significance}])
...
def evaluate_race_age_table(test_chexpert_reports, model_type, metric):
    '''
    ...
    race_age_df = pd.DataFrame(columns = ['Group 1', 'Group 2', f'{metric}: Group 1', f'{metric}: Group 2', 'P-Value', 'Statistical Significance'])
...
def evaluate_sex_age_table(test_chexpert_reports, model_type, metric):
    '''
    ...
    sex_age_df = pd.DataFrame(columns = ['Group 1', 'Group 2', f'{metric}: Group 1', f'{metric}: Group 2', 'P-Value', 'Statistical Significance'])
